...
<img src="./docs/logo.png" alt="Robou Logo" height="120"/>
...
Robou 是一款 AI 工具，能够利用 AI 技术将小说自动转化为剧本，并结合 AI 生成的图片和视频，实现高效的短剧创作。借助 Robou，可以轻松完成从文字到影像的全流程，让短剧制作变得更加智能与便捷。
...
[![Robou 8 分钟快速上手 AI 视频](./docs/videoCover.png)](https://www.bilibili.com/video/BV1na6wB6Ea2)

**Robou 8 分钟快速上手 AI 视频**
...
| :------: | :-------------------------------------------------------- | :---------------------------------------------- | :------------- |
| Windows  | [Release](https://github.com/Robou-Ltd/Robou-app/releases) | [夸克网盘](https://pan.quark.cn/s/94ef07509df0) | 官方发布安装包 |
|  Linux   | [Release](https://github.com/Robou-Ltd/Robou-app/releases) | [夸克网盘](https://pan.quark.cn/s/94ef07509df0) | 官方发布安装包 |
|  macOS   | [Release](https://github.com/Robou-Ltd/Robou-app/releases) | [夸克网盘](https://pan.quark.cn/s/94ef07509df0) | 官方发布安装包 |
...
| 仓库          | 说明                               | GitHub                                          | Gitee                                         |
| ------------- | ---------------------------------- | ----------------------------------------------- | --------------------------------------------- |
| **Robou-app** | 完整客户端（本仓库，推荐普通用户） | [GitHub](https://github.com/Robou-Ltd/Robou-app) | [Gitee](https://gitee.com/Robou-Ltd/Robou-app) |
| **Robou-web** | 前端源代码（适合前端开发者）       | [GitHub](https://github.com/Robou-Ltd/Robou-web) | [Gitee](https://gitee.com/Robou-Ltd/Robou-web) |

> 💡 **提示**：如果您只是想使用 Robou，直接下载本仓库的客户端即可。前端仓库仅供需要二次开发或定制前端界面的开发者使用。
...
<img src="./docs/QR.png" alt="Robou Logo" height="400"/>

---

# 💌 联系我们

📧 邮箱：[ltlctools@outlook.com](mailto:ltlctools@outlook.com?subject=Robou咨询)

---

# 📜 许可证

Robou 基于 AGPL-3.0 协议开源发布，许可证详情：https://www.gnu.org/licenses/agpl-3.0.html

您可以在遵循 AGPL-3.0 相关条款与条件的情况下，将 Robou 用于包括商业目的在内的各类用途。
...
[![Star History Chart](https://api.star-history.com/svg?repos=Robou-Ltd/Robou-app&type=timeline&legend=top-left)](https://www.star-history.com/#Robou-Ltd/Robou-app&type=timeline&legend=top-left)

---

# 🙏 致谢

感谢以下开源项目为 Robou 提供强大支持：
