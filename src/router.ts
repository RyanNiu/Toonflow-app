// @routes-hash 495cae72430801c36de6d9ec7fe07401
...
import route67 from "./routes/storyboard/keepStoryboard";
import route68 from "./routes/storyboard/saveStoryboard";
import route69 from "./routes/storyboard/uploadImage";
import route70 from "./routes/task/getTaskApi";
import route71 from "./routes/task/taskDetails";
import route72 from "./routes/user/addUser";
import route73 from "./routes/user/deleteUser";
import route74 from "./routes/user/getUser";
import route75 from "./routes/user/listUsers";
import route76 from "./routes/user/resetPassword";
import route77 from "./routes/user/saveUser";
import route78 from "./routes/user/updatePassword";
import route79 from "./routes/user/updateRole";
import route80 from "./routes/video/addVideo";
import route81 from "./routes/video/addVideoConfig";
import route82 from "./routes/video/deleteVideoConfig";
import route83 from "./routes/video/generatePrompt";
import route84 from "./routes/video/generateVideo";
import route85 from "./routes/video/getManufacturer";
import route86 from "./routes/video/getVideo";
import route87 from "./routes/video/getVideoConfigs";
import route88 from "./routes/video/getVideoModel";
import route89 from "./routes/video/getVideoStoryboards";
...
export default async (app: Express) => {
  ...
  app.use("/storyboard/keepStoryboard", route67);
  app.use("/storyboard/saveStoryboard", route68);
  app.use("/storyboard/uploadImage", route69);
  app.use("/task/getTaskApi", route70);
  app.use("/task/taskDetails", route71);
  app.use("/user/addUser", route72);
  app.use("/user/deleteUser", route73);
  app.use("/user/getUser", route74);
  app.use("/user/listUsers", route75);
  app.use("/user/resetPassword", route76);
  app.use("/user/saveUser", route77);
  app.use("/user/updatePassword", route78);
  app.use("/user/updateRole", route79);
  app.use("/video/addVideo", route80);
  app.use("/video/addVideoConfig", route81);
  app.use("/video/deleteVideoConfig", route82);
  app.use("/video/generatePrompt", route83);
  app.use("/video/generateVideo", route84);
  app.use("/video/getManufacturer", route85);
  app.use("/video/getVideo", route86);
  app.use("/video/getVideoConfigs", route87);
  app.use("/video/getVideoModel", route88);
  app.use("/video/getVideoStoryboards", route89);
