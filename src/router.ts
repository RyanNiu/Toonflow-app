// @routes-hash 0667308db5d13a932cbfb8bbaf5bc231
...
import route48 from "./routes/setting/getAccountSetting";
...
import route53 from "./routes/setting/getSystemSetting";
import route54 from "./routes/setting/getVideoModelDetail";
import route55 from "./routes/setting/getVideoModelList";
import route56 from "./routes/setting/saveAccountSetting";
import route57 from "./routes/setting/saveSystemSetting";
import route58 from "./routes/setting/updateModel";
import route59 from "./routes/setting/updeteModel";
import route60 from "./routes/storyboard/batchSuperScoreImage";
import route61 from "./routes/storyboard/chatStoryboard";
import route62 from "./routes/storyboard/delStoryboard";
import route63 from "./routes/storyboard/generateShotImage";
import route64 from "./routes/storyboard/generateStoryboardApi";
import route65 from "./routes/storyboard/generateVideoPrompt";
import route66 from "./routes/storyboard/getStoryboard";
import route67 from "./routes/storyboard/getWorkspaceInfo";
import route68 from "./routes/storyboard/keepStoryboard";
import route69 from "./routes/storyboard/saveStoryboard";
import route70 from "./routes/storyboard/uploadImage";
import route71 from "./routes/task/getTaskApi";
import route72 from "./routes/task/taskDetails";
import route73 from "./routes/user/addUser";
import route74 from "./routes/user/deleteUser";
import route75 from "./routes/user/getUser";
import route76 from "./routes/user/listUsers";
import route77 from "./routes/user/resetPassword";
import route78 from "./routes/user/saveUser";
import route79 from "./routes/user/updatePassword";
import route80 from "./routes/user/updateRole";
import route81 from "./routes/video/addVideo";
import route82 from "./routes/video/addVideoConfig";
import route83 from "./routes/video/deleteVideoConfig";
import route84 from "./routes/video/generatePrompt";
import route85 from "./routes/video/generateVideo";
import route86 from "./routes/video/getManufacturer";
import route87 from "./routes/video/getVideo";
import route88 from "./routes/video/getVideoConfigs";
import route89 from "./routes/video/getVideoModel";
import route90 from "./routes/video/getVideoStoryboards";
import route91 from "./routes/video/reviseVideoStoryboards";
import route92 from "./routes/video/saveVideo";
import route93 from "./routes/video/upDateVideoConfig";
...
export default async (app: Express) => {
  ...
  app.use("/setting/getAccountSetting", route48);
  ...
  app.use("/setting/getSystemSetting", route53);
  app.use("/setting/getVideoModelDetail", route54);
  app.use("/setting/getVideoModelList", route55);
  app.use("/setting/saveAccountSetting", route56);
  app.use("/setting/saveSystemSetting", route57);
  app.use("/setting/updateModel", route58);
  app.use("/setting/updeteModel", route59);
  app.use("/storyboard/batchSuperScoreImage", route60);
  app.use("/storyboard/chatStoryboard", route61);
  app.use("/storyboard/delStoryboard", route62);
  app.use("/storyboard/generateShotImage", route63);
  app.use("/storyboard/generateStoryboardApi", route64);
  app.use("/storyboard/generateVideoPrompt", route65);
  app.use("/storyboard/getStoryboard", route66);
  app.use("/storyboard/getWorkspaceInfo", route67);
  app.use("/storyboard/keepStoryboard", route68);
  app.use("/storyboard/saveStoryboard", route69);
  app.use("/storyboard/uploadImage", route70);
  app.use("/task/getTaskApi", route71);
  app.use("/task/taskDetails", route72);
  app.use("/user/addUser", route73);
  app.use("/user/deleteUser", route74);
  app.use("/user/getUser", route75);
  app.use("/user/listUsers", route76);
  app.use("/user/resetPassword", route77);
  app.use("/user/saveUser", route78);
  app.use("/user/updatePassword", route79);
  app.use("/user/updateRole", route80);
  app.use("/video/addVideo", route81);
  app.use("/video/addVideoConfig", route82);
  app.use("/video/deleteVideoConfig", route83);
  app.use("/video/generatePrompt", route84);
  app.use("/video/generateVideo", route85);
  app.use("/video/getManufacturer", route86);
  app.use("/video/getVideo", route87);
  app.use("/video/getVideoConfigs", route88);
  app.use("/video/getVideoModel", route89);
  app.use("/video/getVideoStoryboards", route90);
  app.use("/video/reviseVideoStoryboards", route91);
  app.use("/video/saveVideo", route92);
  app.use("/video/upDateVideoConfig", route93);
}
