  ...
  const tables: TableSchema[] = [
    {
      ...
      initData: async (knex) => {
        ...
        await knex("t_user").insert([{ id: 1, name: "admin", password, is_admin: 1, deleted_at: null }]);
      },
    },
    {
      name: "t_assets",
    ...
    },
    {
      ...
      builder: (table) => {
        ...
        table.primary(["id"]);
        table.unique(["id"]);
        table.unique(["code", "accountId"]); // 代号唯一
      },
      initData: async (knex) => {
...

    {
      ...
      initData: async (knex) => {
        await knex("t_textModel").insert([
          ...
          { manufacturer: "zzgf", model: "gpt-5.2-thinking", responseFormat: "schema", image: 0, think: 1, tool: 1 },
    ...
    },
    {
      ...
      initData: async (knex) => {
        await knex("t_imageModel").insert([
          ...
          { manufacturer: "zzgf", model: "gemini-3.1-flash-image-preview", grid: 1, type: "ti2i" },
        ]);
      },
    },
    {
      ...
      initData: async (knex) => {
        await knex("t_videoModel").insert([
          ...
          },
          {
            ...
            manufacturer: "zzgf",
            model: "sora-2",
            durationResolutionMap: JSON.stringify([{ duration: [4, 8, 10, 12], resolution: ["720p", "1080p"] }]),
            aspectRatio: JSON.stringify(["16:9", "9:16"]),
            audio: 0,
          ...
          },
          {
            ...
            manufacturer: "zzgf",
            model: "sora-2-pro",
            durationResolutionMap: JSON.stringify([{ duration: [4, 8, 10, 12, 15, 25], resolution: ["720p", "1080p"] }]),
            aspectRatio: JSON.stringify(["16:9", "9:16"]),
            audio: 0,
            type: JSON.stringify(["singleImage", "startEndRequired", "multiImage"]),
          },
