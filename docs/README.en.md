<p>
  <a href="https://github.com/Robou-Ltd/Robou-app">
    <img src="https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white" alt="GitHub" />
  </a>
  &nbsp;|&nbsp;
  <a href="https://gitee.com/Robou-Ltd/Robou-app">
...
# Robou
  ...
  <p align="center">
    <a href="https://github.com/Robou-Ltd/Robou-app/stargazers">
      <img src="https://img.shields.io/github/stars/Robou-Ltd/Robou-app?style=for-the-badge&logo=github" alt="Stars Badge" />
    </a>
    ...
    <a href="https://github.com/Robou-Ltd/Robou-app/releases">
      <img alt="release" src="https://img.shields.io/github/v/release/Robou-Ltd/Robou-app?style=for-the-badge" />
    </a>
  </p>
...
Robou is an AI tool that leverages AI technology to automatically turn novels into scripts, then uses AI to generate images and videos for efficient short drama production. With Robou, you can easily accomplish the entire workflow from text to visuals, making short drama creation more intelligent and convenient.
...
[![Robou 8-minute Quick Start AI Video](./videoCover.png)](https://www.bilibili.com/video/BV1na6wB6Ea2)

**Robou 8-Minute Quick Start AI Video**
...
| :--------------: | :-------------------------------------------------------- | :------------------------------------------------- | :------------------------------------ |
|     Windows      | [Release](https://github.com/Robou-Ltd/Robou-app/releases) | [123YunPan](https://www.123865.com/s/bkn5Vv-E67cv) | Official release installation package |
...
```bash
cd /opt
git clone https://github.com/Robou-Ltd/Robou-app.git
cd Robou-app
yarn install
yarn build
```
...
```bash
cd /opt
git clone https://gitee.com/Robou-Ltd/Robou-app.git
cd Robou-app
yarn install
yarn build
```
...
- **GitHub**: [Robou-web](https://github.com/Robou-Ltd/Robou-web)
- **Gitee**: [Robou-web](https://gitee.com/Robou-Ltd/Robou-web)
...
| ------------- | ---------------------------------- | ----------------------------------------------- | --------------------------------------------- |
| **Robou-app** | Full client (this repo, for users) | [GitHub](https://github.com/Robou-Ltd/Robou-app) | [Gitee](https://gitee.com/Robou-Ltd/Robou-app) |
| **Robou-web** | Frontend source (for devs)         | [GitHub](https://github.com/Robou-Ltd/Robou-web) | [Gitee](https://gitee.com/Robou-Ltd/Robou-web) |

> 💡 **Tip**: If you just want to use Robou, download the client from this repo. The web repo is only for frontend customization/development.
...
📧 Email: [ltlctools@outlook.com](mailto:ltlctools@outlook.com?subject=Robou%20Inquiry)

---

# 📜 License

Robou is open source under the AGPL-3.0 license. Details: https://www.gnu.org/licenses/agpl-3.0.html

You may use Robou for any purpose, including commercial, as long as you adhere to the AGPL-3.0 terms and conditions.
...
[![Star History Chart](https://api.star-history.com/svg?repos=Robou-Ltd/Robou-app&type=date&legend=top-left)](https://www.star-history.com/#Robou-Ltd/Robou-app&type=date&legend=top-left)

---

# 🙏 Special Thanks

Thanks to the following open-source projects for empowering Robou:
...
Thanks to the following organizations/individuals for supporting Robou:
